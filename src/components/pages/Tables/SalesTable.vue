<template>
  <div class="sales">
    ...
    <el-form :inline="true" :model="filters">
      <el-form-item>
        <el-dropdown>
          <el-button type="primary"
            ><i class="el-icon-time"></i> 按时间查询</el-button
          >
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item>
              <el-button type="text" size="mini" @click="queryAll"
                >全部</el-button
              >
            </el-dropdown-item>
            <el-dropdown-item>
            ...
            <el-dropdown-item>
              <el-button type="text" size="mini" @click="yesterday"
                >昨天</el-button
              >
            </el-dropdown-item>
            <el-dropdown-item>
              <el-button type="text" size="mini" @click="lastWeek"
                >上周</el-button
              >
            </el-dropdown-item>
            <el-dropdown-item>
              <el-button type="text" size="mini" @click="lastMonth"
                >上月</el-button
              >
            </el-dropdown-item>
          </el-dropdown-menu>
      ...
      <el-form-item>
        <el-button type="primary" @click="handleExportSelect"
          >导出所选</el-button
        >
      </el-form-item>
    </el-form>
  ...
  methods: {
    ...
    handleExportSelect() {
      if (this.fileName == "") {
        ...
        if (this.multipleSelection.length == 0) this.$message.warning("请选择");
        else this._handleExport(this.multipleSelection);
      }
    },
