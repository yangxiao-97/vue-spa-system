    ...
    >
      ...
      >
        <template slot-scope="scope">
          <el-tag
            :type="scope.row.empState === '就职' ? 'success' : 'danger'"
            close-transition
            >{{ scope.row.empState }}</el-tag
          >
        </template>
      </el-table-column>
    ...
    <el-dialog title="编辑信息" :visible.sync="editVisible">
      ...
      >
        ...
        <el-form-item label="家庭住址" prop="empAddress">
          <el-input v-model="editForm.empAddress" width="300"></el-input>
        </el-form-item>
      </el-form>
    ...
    <el-dialog title="新增信息" :visible.sync="addVisible">
      ...
      >
        ...
        <el-form-item label="详细住址" placeholder="街道/小区">
          <el-input v-model="option.add.addrDetail" width="300"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        ...
        if (valid) {
          ...
          axios
            ...
            .then(res => {
              ...
              (this.option.edit.addrCity = []), this.queryAll();
        ...
        if (valid) {
          ...
          axios
            .post("api/employee/add", {
              ...
              empQQ: params.empQQ,
              empAddress:
                this.option.add.addrCity.toString().replace(/,/g, " ") +
