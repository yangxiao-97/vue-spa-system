    ...
    <el-table
      ...
      >
        <template slot-scope="scope">
          <el-tag
            :type="scope.row.supState === '已启用' ? 'success' : 'danger'"
            close-transition
            >{{ scope.row.supState }}</el-tag
          >
        </template>
      </el-table-column>
